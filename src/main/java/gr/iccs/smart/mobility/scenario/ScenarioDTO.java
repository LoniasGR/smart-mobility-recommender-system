...
public record ScenarioDTO(List<PortDTO> ports, @JsonProperty("bus_stops") List<BusStopDTO> busStops,
                @JsonProperty("passenger_cars") List<CarDTO> cars, List<ScooterDTO> scooters,
